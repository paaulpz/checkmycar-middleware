...
public class ClienteServiceImpl implements ClienteService {
    ...
    public Results<ClienteDTO> findByCriteria(ClienteCriteria criteria, int from, int pageSize) {
    ...
    public Long register(Cliente usuario) {
        ...
        if (registrado != null) {
            mailService.sendEmail(
                ...
                "Hola " + registrado.getNombre() + ", su cuenta de usuario ha sido registrada.",
                "el equipo de checkmycar"
            );
        }
    ...
    public ClienteDTO login(String dni, String password) {
        ...
        Results<ClienteDTO> resultados = clienteDAO.findByCriteria(criteria, 1, 1);
